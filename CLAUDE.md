...
- **Таймаут экспорта**: Увеличен до 14 400 секунд (4 часа) для поддержки огромных бинарников в детальном режиме. Таймаут diff: 10 минут. Watchdog бездействия диска сработает через 120 секунд.
