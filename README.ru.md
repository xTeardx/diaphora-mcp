...
- [Кросс-бинарное сопоставление функций с Diaphora + idalib-mcp](examples/idalib_mcp_matching.ru.md): Пошаговое руководство по сопоставлению функций в разных сборках одной библиотеки, извлечению пар адресов через SQLite и переносу метаданных реверс-инжиниринга без GUI.
