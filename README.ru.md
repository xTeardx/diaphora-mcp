...
- [Сравнение sqlite3.dll (Python vs AIMP)](examples/sqlite3_example.md): Пошаговое руководство по экспорту, диффингу и сравнению функций с разным смещением адресов на примере реальных системных файлов.
